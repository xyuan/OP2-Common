//
// auto-generated by op2.m on 12-Jul-2012 09:13:34
//
...
void op_par_loop_res_calc(char const *name, op_set set,
  ...
  args[2] = arg2;
  for (int v = 1; v < 2; v++) {
    args[2 + v] = op_arg_dat(arg2.dat, v, arg2.map, 4, "float", OP_READ);
  }
  arg4.idx = 0;
  args[4] = arg4;
  for (int v = 1; v < 2; v++) {
  ...
  args[6] = arg6;
  for (int v = 1; v < 2; v++) {
    args[6 + v] = op_arg_dat(arg6.dat, v, arg6.map, 4, "float", OP_INC);
  }
